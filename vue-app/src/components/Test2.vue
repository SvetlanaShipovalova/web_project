  ...
  <div class="container mt-5 text-center">
    ...
    <div id="app">
      <div v-if="currentView === 'start'">
        ...
        <p><strong>Цель игры:</strong> Число отображается на экране в течение нескольких секунд, затем исчезает. Ваша задача — запомнить показанное число и затем выбрать его на экране.</p>
