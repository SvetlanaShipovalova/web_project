...
<strong>Цель игры:</strong> Определить, в какой из копилок больше денег, выбрав правильный вариант. <br>
<strong>Ваша задача</strong> — быстро определить, в какой из копилок больше монет, и кликнуть по правильному варианту. За каждый правильный ответ начисляется балл, а итоговый результат зависит от количества верных ответов и времени прохождения.
<br><strong>Правила:</strong> Если в обеих копилках одинаковое количество монет, вы можете выбрать любую из них. Время выполнения не ограничено, это тест на ваше внимание и наблюдательность.
    ...
    <router-link to="/tests" class="btn btn-secondary mt-3">Назад к тестам</router-link> <br>
  </div>
</template>
