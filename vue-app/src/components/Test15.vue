  ...
  <div class="container mt-5 text-center">
    ...
    <div id="app">
      <div>
        ...
        <p>
          <strong>"Тест на математическую внимательность"</strong> — это игра для тренировки концентрации и быстрого анализа чисел.
        </p>
        <p>
          <strong>Цель игры:</strong> Определять, равны ли показанные числа, и нажимать соответствующую кнопку.
        </p>
