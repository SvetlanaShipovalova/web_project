...
const testComponents = {
  ...
  //'4': defineAsyncComponent(() => import('../components/Test4.vue')),
  '6': defineAsyncComponent(() => import('../components/ComparisonGame.vue')),
  '7': defineAsyncComponent(() => import('../components/PiggyBankGame.vue')),
